...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (result.success) {
            const user = JSON.parse(localStorage.getItem('dashboard_user_data'));
            if (user.role === 'agent') {
                navigate('/salesman');
            } else {
                navigate('/admin');
    ...
    return (
        <div className="h-screen w-full bg-[#FAFAFF] relative flex items-center justify-center p-4 lg:p-8 overflow-hidden font-space">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    font-space font-semibold text-[18px] leading-[150%] text-white
